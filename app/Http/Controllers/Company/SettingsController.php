...
class SettingsController extends Controller
{
    ...
    public function updateNoteValue(Request $request)
    {
        ...
        $float_number = isset($request->float_number) && $request->float_number == 'dot' ? '.' : ',';
        ...
        $formatted_price = (($request->site_currency_symbol_position == "pre") ? $symbol : '') . ($currency_space == 'withspace' ? ' ' : '') . $price . ($currency_space == 'withspace' ? ' ' : '') . (($request->site_currency_symbol_position == "post") ? $symbol : '');
