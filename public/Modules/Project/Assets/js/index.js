$(document).ready(function () {
    ...
    $(document).on('click', '.bulk_action a', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                let total = selectedData.length;
                let timerInterval;
                Swal.fire({
                    icon: 'success',
                    title: `${type} Successful!`,
                    html: `<b>${total}</b> projects have been moved to ${type}`,
                    ...
                    didOpen: () => {
                        ...
                        timerInterval = setInterval(() => {
                            if (total > 1) { // Only decrease if greater than 1
                                total--;
                                b.textContent = `${total}`;
                            } else {
                                clearInterval(timerInterval); // Stop when it reaches 1
                            }
