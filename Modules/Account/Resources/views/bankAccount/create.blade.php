    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('opening_balance', '', ['class' => 'form-control', 'min' => '0', 'placeholder' => __('Enter Opening Balance')]) }}
            </div>
        </div>
        <div class="col-md-6 bank">
            <div class="form-group">
        ...
        <div class="col-md-6 bank">
            <div class="form-group">
                ...
                {{ Form::text('bank_branch', '', array('class' => 'form-control',"min"=>"0",'placeholder' => __('Enter Bank Branch'))) }}
            </div>
        </div>
        <div class="col-md-6 bank">
            <div class="form-group">
