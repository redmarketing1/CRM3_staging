...
$(document).ready(function () {
  function loadDataTables() {
    var _$$DataTable;
    var table = $('#projectsTable').DataTable((_$$DataTable = {
      pageLength: 50,
      lengthMenu: [[25, 50, 100, 200], [25, 50, 100, 200]],
      lengthChange: true,
      ordering: false,
      searching: true
    }, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_$$DataTable, "ordering", false), "layout", {
      topEnd: null
    }), "select", {
      style: 'multi'
      ...
      render: function render(url) {
        return "<div class=\"data-thubmnail\"><img src=\"".concat(url, "\"></div>");
      }
    }, {
      data: 'status_data',
      visible: false,
      ...
      render: function render(data) {
        if (data && data.name) {
          var backgroundColor = data.background_color || '#ffffff';
          var fontColor = data.font_color || '#555555';
          return "<span class=\"data-project-status\" style=\"background-color: ".concat(backgroundColor, "; color: ").concat(fontColor, ";\">").concat(data.name, "</span>");
        } else {
      ...
      render: function render(data) {
        if (data && data.name) {
          var backgroundColor = data.background_color || '#ffffff';
          var fontColor = data.font_color || '#555555';
          return "<span class=\"data-project-priority\" style=\"background-color: ".concat(backgroundColor, "; color: ").concat(fontColor, ";\">").concat(data.name, "</span>");
        } else {
          return "<span class=\"no-data\">-</span>";
        }
      }
    ...
    }), _defineProperty(_$$DataTable, "initComplete", function initComplete(settings, _ref) {
      var data = _ref.data,
