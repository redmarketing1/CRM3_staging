<div class="actions">
    <div class="action-btn bg-primary ms-2">
        <a data-size="lg" data-url="{{ $project->url() }}" class="btn btn-sm d-inline-flex align-items-center text-white "
            data-ajax-popup="true" data-bs-toggle="tooltip" data-title="{{ trans('Edit Project') }}"
