...
$(document).ready(function () {
  ...
  $.fn.dataTable.ext.search.push(function (settings, data, dataIndex) {
    ...
    if ((!selectedStatus || projectStatus.includes(selectedStatus)) && (!selectedDropdownStatus.length || selectedDropdownStatus.includes(projectStatus)) && (!selectedDropdownPriority.length || selectedDropdownPriority.some(function (priority) {
