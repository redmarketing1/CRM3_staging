                    ...
                    <ul class="list-unstyled mb-0 m-2 py-2">
                        ...
                        <div class="text-end">
                            <a href="#" data-size="md" class="btn btn-sm btn-primary" data-ajax-popup-over="true" data-size="md"
                                data-title="{{ __('Generate product Name') }}" data-url="{{ route('generate', ['notification template']) }}"
                    ...
                    <li class="dropdown dash-h-item drp-language">
                        ...
                        <div class="dropdown-menu dash-h-dropdown dropdown-menu-end"
                            ...
                            @foreach ($languages as $k => $lang)
                                <a href="{{ route('ai-templates.index', [$notification_template->id, $k]) }}"
                    ...
                    <li class="dropdown dash-h-item drp-language">
                        ...
                        <div class="dropdown-menu dash-h-dropdown dropdown-menu-end" aria-labelledby="dropdownLanguage">
                            @foreach ($notification_templates as $notification_template)
                                <a href="{{ route('ai-templates.index', [$notification_template->id,(Request::segment(3)?Request::segment(3):\Auth::user()->lang)]) }}"
		...
		<div class="col-xl-12">
			<div class="card">
				...
				<h5 class= "font-weight-bold pb-3">{{ __('Placeholders') }}</h5>
					...
					{{Form::model($curr_noti_tempLang,array('route' => array('ai-templates.update', $curr_noti_tempLang->parent_id), 'method' => 'PUT')) }}
						<div class="row">
							<div class="form-group col-12">
								{{Form::label('content',__('Notification Message'),['class'=>'form-label text-dark'])}}
								{{Form::textarea('content',$curr_noti_tempLang->content,array('class'=>'form-control notification-content','required'=>'required','rows'=>'04','placeholder'=>'EX. Hello, {company_name}'))}}
