...
Alpine.data('estimationShow', function () {
  return {
    ...
    updatePOSNumbers: function updatePOSNumbers() {
      var rows = document.querySelectorAll('.item_row');
      var currentGroup = '';
      var groupCounter = 1;
      var itemCounter = 1;
      rows.forEach(function (row) {
        var groupId = row.dataset.group_id;
        ...
        var posNumber = "".concat(groupCounter.toString().padStart(2, '0'), ".").concat(itemCounter.toString().padStart(2, '0'));
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _this2.items.push(_objectSpread({}, _this2.newItem));
            case 1:
            case "end":
