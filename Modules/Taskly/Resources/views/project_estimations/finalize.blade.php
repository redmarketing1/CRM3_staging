                        ...
                        <div class="final-left-col card-body">
                            <div class="row final-pdf-paper d-flex justify-content-center">
                                <div class="col-md-12">
                                    ...
                                    $data = ['estimation' => $estimation, 'settings' => $settings, 'quote' => $quote, 'client' => $client, 'client_name' => $client_name, 'client_email' => $client_email, 'contractor' => $contractor];
                                    ?>
                                ...
                                <div class="col-12">
                                    <div class="col-12">
                                        <div class="final-send-wrapper">
                                            <div class="mt-3">
                                                <form action="{{ route('estimations.quote.send.client') }}" id="print"
                                                    method="post">
                                                    <input type="hidden" name="id" value="{{ $estimation->id }}">
                                                    <input type="hidden" name="type" value="pdf">
                                                    <input type="hidden" name="subject" value="" id="print-subject">
                                                    <input type="hidden" name="client_email" id="print-client_email"
                                                        value="">
                                                    <input type="hidden" name="email_text" id="print-email_text"
                                                        value="">
                                                    <input type="hidden" name="extra_notes" id="print-extra_notes"
                                                        value="">
                                                    <input type="hidden" name="pdf_top_notes" id="print-pdf-top-notes"
                                                        value="">
                                                    <input type="hidden" name="project_images_files"
                                                        id="print-pdf-project-images-files" value="">
                                                    <input type="hidden" name="project_other_files"
                                                        id="print-pdf-project-other-files" value="">
                                                    @csrf
                                                </form>
                                                <div class="btn-group float-end">
                                                    <button
                                                        class="btn bg-primary text-white btn-icon rounded-pill dropdown-toggle final-send-btn"
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a href="javascript:void(0)"
                                                            onclick="send('{{ $estimation->id }}', 'email')"
                                                            class="dropdown-item final-email-btn"><i
                                                                class="fa-regular fa-paper-plane"></i>
                                                            {{ __('Send to Client') }}</a>
                                                        <a href="javascript:void(0)"
                                                            onclick="send('{{ $estimation->id }}', 'save')"
                                                            class="dropdown-item final-save-btn"><i
                                                                class="fa-regular fa-floppy-disk"></i>
                                                            {{ __('Finish and save') }}</a>
                                                        <a href="javascript:void(0)"
                                                            onclick="send('{{ $estimation->id }}', 'pdf')"
                                                            class="dropdown-item final-download-btn"><i
                                                                class="fa-regular fa-circle-down"></i>
                                                            {{ __('Finish and download') }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="final-email-header">
                                            @if (isset($estimation->project()->client_data->first_name))
                                                <label
                                                    for="">{{ (isset($estimation->project()->client_data->salutation) ? __($estimation->project()->client_data->salutation) : '') . ' ' . $estimation->project()->client_data->first_name . ' ' . $estimation->project()->client_data->last_name }}</label>
                                            @endif
                                            <div class="col-12 pt-1">
                                                <label for="" class="form-label">{{ __('Client Email') }}</label>
                                                <input type="email" name="client_email" class="form-control"
                                                    id="client_email"
                                                    value="{{ isset($estimation->project()->construction_detail->email) ? $estimation->project()->construction_detail->email : '' }}">
                                            </div>
                                            <div class="col-12 pt-1 tag_box">
                                                <label for="" class="form-label mt-1">{{ __('Other CC-E-Mails') }}
                                                    ({{ __('Separate emails with Comma') }})</label>
                                                <input type="text" name="cc_email" class="form-control tagInput"
                                            ...
                                            <div class="col-12 pt-1 tag_box">
                                                <label for=""
                                                    class="form-label mt-1">{{ __('Other BCC-E-Mails') }}
                                                    ({{ __('Separate emails with Comma') }})</label>
                                                <input type="text" name="bcc_email" class="form-control tagInput"
                                                    placeholder="Enter Email" value=""
                                                    onkeydown="handleKeyPress(event)">
                                                <div class="tagContainer"></div>
                                                <div class="tagList" class="d-none"></div>
                                            ...
                                            @if (isset($quote->subContractor->email))
                                                <label class="company-cc"><input type="checkbox" class="form-check-input"
                                                        ...
                                                        value="{{ $quote->subContractor->email }}" />
                                                    {{ __('Send copy to Subcontractor') }}
                                                    {{ $quote->subContractor->email }}</label>
                                            @endif
                                        </div>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-2" style="align-content:center;">
                                                <span class="col-12 lright variable-box">
                                                    ...
                                                    <div class="variable-items">
                                                        ...
                                                        <div class="section">
                                                            <a href="javascript:void(0)" id="con20"
                                                                onclick="copyToClipboard('#con20')"
                                                                class="list-group-item list-group-item-action border-0">{estimation.title}</a>
                                                            <a href="javascript:void(0)" id="con1"
                                                                onclick="copyToClipboard('#con1')"
                                                                class="list-group-item list-group-item-action border-0">{client_name}</a>
                                                            <a href="javascript:void(0)" id="con2"
                                                                onclick="copyToClipboard('#con2')"
                                                                class="list-group-item list-group-item-action border-0">{client.company_name}</a>
                                                            <a href="javascript:void(0)" id="con3"
                                                                onclick="copyToClipboard('#con3')"
                                                                class="list-group-item list-group-item-action border-0">{client.salutation_title}</a>
                                                            <a href="javascript:void(0)" id="con4"
                                                                onclick="copyToClipboard('#con4')"
                                                                class="list-group-item list-group-item-action border-0">{client.academic_title}</a>
                                                            <a href="javascript:void(0)" id="con5"
                                                                onclick="copyToClipboard('#con5')"
                                                                class="list-group-item list-group-item-action border-0">{client.first_name}</a>
                                                            <a href="javascript:void(0)" id="con6"
                                                                onclick="copyToClipboard('#con6')"
                                                                class="list-group-item list-group-item-action border-0">{client.last_name}</a>
                                                            <a href="javascript:void(0)" id="con7"
                                                                onclick="copyToClipboard('#con7')"
                                                                class="list-group-item list-group-item-action border-0">{client.email}</a>
                                                            <a href="javascript:void(0)" id="con8"
                                                                onclick="copyToClipboard('#con8')"
                                                                class="list-group-item list-group-item-action border-0">{client.phone}</a>
                                                            <a href="javascript:void(0)" id="con9"
                                                                onclick="copyToClipboard('#con9')"
                                                                class="list-group-item list-group-item-action border-0">{client.mobile}</a>
                                                            <a href="javascript:void(0)" id="con21"
                                                                onclick="copyToClipboard('#con21')"
                                                                class="list-group-item list-group-item-action border-0">{client.salutation}</a>
                                                            <a href="javascript:void(0)" id="con22"
                                                                onclick="copyToClipboard('#con22')"
                                                                class="list-group-item list-group-item-action border-0">{construction.salutation}</a>
                                                        </div>
                                                        <div class="section">
                                                            <a href="javascript:void(0)" id="con10"
                                                                onclick="copyToClipboard('#con10')"
                                                                class="list-group-item list-group-item-action border-0">{client.website}</a>
                                                            <a href="javascript:void(0)" id="con11"
                                                                onclick="copyToClipboard('#con11')"
                                                                class="list-group-item list-group-item-action border-0">{construction.street}</a>
                                                            <a href="javascript:void(0)" id="con12"
                                                                onclick="copyToClipboard('#con12')"
                                                                class="list-group-item list-group-item-action border-0">{construction.additional_address}</a>
                                                            <a href="javascript:void(0)" id="con13"
                                                                onclick="copyToClipboard('#con13')"
                                                                class="list-group-item list-group-item-action border-0">{construction.zipcode}</a>
                                                            <a href="javascript:void(0)" id="con14"
                                                                onclick="copyToClipboard('#con14')"
                                                                class="list-group-item list-group-item-action border-0">{construction.city}</a>
                                                            <a href="javascript:void(0)" id="con15"
                                                                onclick="copyToClipboard('#con15')"
                                                                class="list-group-item list-group-item-action border-0">{construction.state}</a>
                                                            <a href="javascript:void(0)" id="con16"
                                                                onclick="copyToClipboard('#con16')"
                                                                class="list-group-item list-group-item-action border-0">{construction.country}</a>
                                                            <a href="javascript:void(0)" id="con17"
                                                                onclick="copyToClipboard('#con17')"
                                                                class="list-group-item list-group-item-action border-0">{construction.tax_number}</a>
                                                            <a href="javascript:void(0)" id="con18"
                                                                onclick="copyToClipboard('#con18')"
                                                                class="list-group-item list-group-item-action border-0">{construction.notes}</a>
                                                            <a href="javascript:void(0)" id="con19"
                                                                onclick="copyToClipboard('#con19')"
                                                                class="list-group-item list-group-item-action border-0">{current.date+21days}</a>
                                                        </div>
                                                    </div>
                                                </span>
                                            </div>
                                            <div class="col-12 pt-1">
                                                <label for=""
                                                    class="form-label mt-1">{{ __('E-Mail-Text') }}</label>
                                                <div id="email-text"></div>
                                            </div>
                                            <div class="final-attachments">
                                                <div class="col-12 pt-1 mt-2">
                                                    @if (!empty($additional_files_list))
                                                        <h6><i class="fa-solid fa-paperclip"></i>
                                                            {{ __('Attach Additional files to Email') }}</h6>
                                                        <ul>
                                                            @foreach ($additional_files_list as $row)
                                                                <li>
                                                                    <input type="checkbox"
                                                                        ...
                                                                        value="{{ $row->getRelativePathname() }}" />
                                                                    <a href="{{ asset('public/additional_files/' . $row->getRelativePathname()) }}"
                                                                        target="_blank">
                                                ...
                                                <div class="col-12 pt-1">
                                                    <h6><i class="fa-solid fa-paperclip"></i>
                                                        {{ __('Attach Additional Formats to Email') }}</h6>
                                                    <ul>
                                                        <li><label><input type="checkbox"
                                                                    class="form-check-input additional_format_files_list"
                                                                    name="additional_format_files_list[]"
                                                                    value="gaeb" /> <a
                                                                    href="{{ route('estimation.export.gaeb', ['id' => \Crypt::encrypt($estimation->id), 'type' => 'attachment-download']) }}"
                                                                    target="_blank">{{ __('Attach GAEB Format') }}</a></label>
                                                        </li>
                                                        <li><label><input type="checkbox"
                                                                    class="form-check-input additional_format_files_list"
                                                                    name="additional_format_files_list[]"
                                                                    value="excel" /> <a
                                                                    href="{{ route('estimation.export.excel', ['id' => \Crypt::encrypt($estimation->id), 'type' => 'attachment-download']) }}"
                                                                    target="_blank">{{ __('Attach EXCEL Format') }}</a></label>
                                                        </li>
                                                        <li><label><input type="checkbox"
                                                                    class="form-check-input additional_format_files_list"
                                                                    name="additional_format_files_list[]"
                                                                    value="csv" /> <a
                                                                    href="{{ route('estimation.export.csv', ['id' => \Crypt::encrypt($estimation->id), 'type' => 'attachment-download']) }}"
                                                                    target="_blank">{{ __('Attach CSV Format') }}</a></label>
                                                        </li>
                                                        <li><label><input type="checkbox"
                                                                    class="form-check-input additional_format_files_list"
                                                                    name="additional_format_files_list[]"
                                                                    value="image_zip" /> <a href="#"
                                                                    class="download_images_zip"
                                                                    target="_blank">{{ __('Attach Images as ZIP-File') }}</a></label>
                                                        </li>
                                                        <form action="{{ route('estimation.create.imageszip') }}"
                                                            id="download_images_zip" method="post" target="_blank">
                                                            <input type="hidden" name="id"
                                                                value="{{ $estimation->id }}">
                                                            <input type="hidden" name="type"
                                                                value="attachment-download">
                                                            <input type="hidden" name="project_images"
                                                                id="zip_project_images_files" value="">
                                                            @csrf
                                                        </form>
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="col-12 pt-1 project-attachments mt-2">
                                                    @if (!empty($project_images_files))
                                                        <h6><i class="fa-regular fa-square-plus"></i>
                                                            {{ __('Add Project Images to PDF') }}</h6>
                                                        <div class="row img-row">
                                                            @foreach ($project_images_files as $prow)
                                                                <div class="col-md-5">
                                                                    <div class="project_file_container">
                                                                        <label>
                                                                            <img src="{{ get_file($prow->file_path) }}"
                                                                                class="img-thumbnail" />
                                                                            <input type="checkbox"
                                                                                class="form-check-input project_images_files_checkbox"
                                                                                name="project_images_files_list[]"
                                                                                value="{{ encrypt($prow->id) }}"
                                                                                checked />
                                                                        </label>
                                                                    </div>
                                                                </div>
