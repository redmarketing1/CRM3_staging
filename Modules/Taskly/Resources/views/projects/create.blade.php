...
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-md-12">
            ...
            {{ Form::text('name', '', ['class' => 'form-control', 'required' => 'required', 'id' => 'projectname', 'placeholder' => __('Project Name')]) }}
        </div>
        <div class="form-group col-md-12">
            {{ Form::label('projectname', __('Description'), ['class' => 'form-label']) }}
            {{ Form::textarea('description', '', ['class' => 'form-control tinyMCE', 'rows' => 10, 'id' => 'description', 'placeholder' => __('Add Description')]) }}
        </div>
        <div class="form-group col-md-12">
            {{ Form::label('users_list', __('Users'), ['class' => 'form-label']) }}
            <select class=" multi-select choices" id="users_list" name="users_list[]" multiple="multiple"
