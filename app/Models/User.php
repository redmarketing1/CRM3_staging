...
public function assignPlan($plan_id = null,$duration = null,$modules = null,$counter = null,$user_id = null)
	...
	// Define the inverse of the polymorphic relationship for sent emails
	public function sentEmails()
	{
		return $this->hasMany(Email::class, 'sender_id');
	}

	// Define the inverse of the polymorphic relationship for received emails
