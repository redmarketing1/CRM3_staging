    ...
    <div class="col-md-12">
        <div class="card deta-card table-card">
                    ...
                    <div class="d-inline-flex">
                        ...
                        <button class="text-muted bg-white d-sm-flex align-items-center py-0">
                            <a class="btn btn-sm btn-primary" data-size="lg" data-ajax-popup="true"
                                ...
                                data-url="{{ route('project.comment.index', [$project->id]) }}" data-toggle="tooltip"
                                title="Add Comments" data-bs-original-title="Add Comments" aria-label="popup">
            ...
            <div class="card-body p-3">
                <table class="timeline timeline-one-side" data-timeline-content="axis"
