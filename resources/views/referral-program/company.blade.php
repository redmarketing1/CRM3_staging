                ...
                <div class="col-xl-3">
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            <a href="#" class="border-0 list-group-item list-group-item-action tab-link active"
                                data-tab="guideline">{{ __('GuideLine') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                            <a href="#" class="border-0 list-group-item list-group-item-action tab-link"
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-md-6 ">
                                    <div class = "p-3 border border-2">
                                        <h4>{{ __('Refer ') . $companyName .  __(' and earn ') . admin_setting('defult_currancy_symbol') . (isset($setting) ? $setting->percentage : '') . __(' per paid signup!') }}</h4>
                                        {!! isset($setting) ? $setting->guideline : '' !!}
                                    </div>
                                </div>
                                <div class="mt-5 col-lg-6 col-sm-6 col-md-6">
                                ...
                                @if(isset($setting) && $setting->is_enable == 0 || !isset($setting))
                                        <h6 class="mt-2 text-end text-danger text-md">{{ __('Note : super admin has disabled the referral program.') }}</h6>
                                    @endif
                            </div>
                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($transaction->status == 0)
                                                            <span
                                                                class="p-2 px-3 rounded status_badge badge bg-danger">{{ __(\App\Models\TransactionOrder::$status[$transaction->status]) }}</span>
                                                        @elseif($transaction->status == 1)
                                                            <span
                                                                class="p-2 px-3 rounded status_badge badge bg-warning">{{ __(\App\Models\TransactionOrder::$status[$transaction->status]) }}</span>
                                                        @elseif($transaction->status == 2)
                                                            <span
                                                                class="p-2 px-3 rounded status_badge badge bg-primary">{{ __(\App\Models\TransactionOrder::$status[$transaction->status]) }}</span>
                                                        @endif
                                                    </td>
