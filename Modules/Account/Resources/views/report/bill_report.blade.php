                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($purchase->status == 0)
                                                                <span
                                                                    class="badge fix_badges bg-primary p-2 px-3 rounded purchase_status">{{ __(App\Models\Purchase::$statues[$purchase->status]) }}</span>
                                                            @elseif($purchase->status == 1)
                                                                <span
                                                                    class="badge fix_badges bg-info p-2 px-3 rounded purchase_status">{{ __(App\Models\Purchase::$statues[$purchase->status]) }}</span>
                                                            @elseif($purchase->status == 2)
                                                                <span
                                                                    class="badge fix_badges bg-secondary p-2 px-3 rounded purchase_status">{{ __(App\Models\Purchase::$statues[$purchase->status]) }}</span>
                                                            @elseif($purchase->status == 3)
                                                                <span
                                                                    class="badge fix_badges bg-warning p-2 px-3 rounded purchase_status">{{ __(App\Models\Purchase::$statues[$purchase->status]) }}</span>
                                                            @elseif($purchase->status == 4)
                                                                <span
                                                                    class="badge fix_badges bg-danger p-2 px-3 rounded purchase_status">{{ __(App\Models\Purchase::$statues[$purchase->status]) }}</span>
                                                            @endif
                                                        </td>
