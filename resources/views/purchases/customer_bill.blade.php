    ...
    <div class="mb-3 row justify-content-between align-items-center">
        <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
            ...
            <div class="mx-2 all-button-box">
                ...
                <a href="{{ route('purchases.pdf', \Crypt::encrypt($purchase->id))}}" target="_blank" class="mt-3 btn btn-primary">
                    {{__('Download')}}
                </a>
            </div>
                        ...
                        <div class="invoice-print">
                            <div class="mt-2 row invoice-title">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-12 text-end">
                                    <h3 class="float-right invoice-number"></h3>
...
<footer id="footer-main">
    <div class="footer-dark">
        <div class="container">
            <div class="py-4 mt-4 row align-items-center justify-content-md-between delimiter-top">
                <div class="col-md-6">
                    <div class="text-sm text-center copyright font-weight-bold text-md-left">
                ...
                <div class="col-md-6">
                    <ul class="mt-3 nav justify-content-center justify-content-md-end mt-md-0">
                        <li class="nav-item">
