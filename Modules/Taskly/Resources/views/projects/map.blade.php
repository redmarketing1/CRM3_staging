...
<a href="{{route('projects.index')}}">{{ __('All Project') }}</a>,{{__('Project Map')}}
@endsection
@push('css')
<style>
	#map {
			...
			<div class="card map-card no-padding">
				<div class="card-header map_filter p-3 text-end">
					<div class="form-group">
						<input type="checkbox" class="form-check-input map_address_type" id="construction_address" value="construction" checked />
						<label class="form-check-label f-w-600 pt-1 ms-1" for="construction_address">Construction Address</label>
						&nbsp;&nbsp;
						<input type="checkbox" class="form-check-input map_address_type" id="invoice_address" value="invoice" />
...
@endsection
@push('scripts')
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBbTqlUNbqPssvetzvRl4n65HB2g_-o9tE&callback=initMap&libraries=places&v=weekly" defer></script>
	<script type="application/javascript">
		...
		markerLocations = {!! json_encode($project_location) !!};
