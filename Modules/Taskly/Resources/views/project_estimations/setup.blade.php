...
@section('page-breadcrumb')
    <a href="{{ route('project.index') }}">{{ __('All Project') }}</a>,<a
        href="{{ route('project.show', [$estimation->project_id]) }}">{{ $estimation->getProjectDetail->name }}</a>,{{ __('Edit') }}
@endsection
                        ...
                        <div class="card repeater table-card-full">
                            ...
                            <div class="card-body pb-0">
                                <div class="row estimation-header">
                                    @php
                                        ...
                                        if (
                                            ...
                                            Auth::user()->isAbleTo('estimation import') == false
                                        ) {
                                            $col_md_class = 'col-md-4';
                                            $is_display_import = 'd-none';
                                        }
                                    ...
                                    <div class="{{ $col_md_class }}">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ $estimation->project()->name }}" readonly>
                                    ...
                                    <div class="{{ $col_md_class }}">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="title" id="estimation_title" type="text"
                                    ...
                                    <div class="{{ $col_md_class }}">
                                        <div class="form-group">
                                            ...
                                            {{ Form::date('issue_date', new \DateTime(), ['class' => 'form-control', 'required' => 'required']) }}
                                        </div>
                                    </div>
                                    @if (count($estimation->estimation_products) == 0)
                                        ...
                                        <thead>
                                            <tr class="total-line-top no-sort" id="net_with_discount_row">
                                                ...
                                                <th colspan="3" class="toplabel total-net-discount"
                                                    data-dt-order="disable">{{ __('Net incl. Discount') }}</th>
                                                @if (isset($ai_description_field))
                                                    <th id="" rowspan="5"
                                                        class="border-left-right toptotal ai-head column_ai_description"
                                                ...
                                                @foreach ($total_prices['net_with_discount'] as $net_with_discount_key => $net_with_discount)
                                                    <th colspan="2" id="{{ $net_with_discount_key }}_neuwest"
                                                        ...
                                                        <input type="hidden" id="{{ $net_with_discount_key }}_value"
                                                            name="{{ $net_with_discount_key }}"
                                            ...
                                            <tr class="total-line-top no-fixed-header no-sort" id="gross_with_discount_row">
                                                ...
                                                <th colspan="3" class="toplabel total-gross-discount"
                                                    data-dt-order="disable">{{ __('Gross incl. Discount') }}</th>
                                                ...
                                                @foreach ($total_prices['gross_with_discount'] as $gross_with_discount_key => $gross_with_discount)
                                                    <th colspan="2" id="{{ $gross_with_discount_key }}_neuwest"
                                                        ...
                                                        <input type="hidden" id="{{ $gross_with_discount_key }}_value"
                                                            name="{{ $gross_with_discount_key }}"
                                            ...
                                            <tr class="total-line-top no-fixed-header no-sort" id="net_row1">
                                                ...
                                                @foreach ($total_prices['net'] as $net_key => $net)
                                                    <th colspan="2" id="{{ $net_key }}_neuwest"
                                                        class="totalnr {{ $net_key }} toptotal total-net border-left-right"
                                                        data-dt-order="disable">
                                                        <div id="{{ $net_key }}" class="">
                                                            {{ currency_format_with_sym($net) }}
                                                        </div>
                                                        <input type="hidden" id="{{ $net_key }}_value"
                                                            name="{{ $net_key }}" value="{{ $net }}">
                                                    </th>
                                                @endforeach
                                            </tr>
                                            <tr class="total-line-top no-fixed-header" id="gross_row">
                                                <th colspan="3" class="toplabel total-gross no-sort"
                                                    data-dt-order="disable">{{ __('Gross (incl. VAT)') }}</th>
                                                    ...
                                                    <th colspan="2"
                                                        ...
                                                        <span class="dt-column-title">
                                                            <div id="{{ $tax_key }}_neuwest"
                                                                ...
                                                                <select name="tax[{{ $tax_key }}]"
                                                                    id="{{ $tax_key }}">
                                                                    <option value="19"
                                                                        {{ $tax[$tax_key] == 19 ? 'selected' : '' }}>19%</option>
                                                                    <option value="0"
                                                                        {{ $tax[$tax_key] == 0 ? 'selected' : '' }}>0%</option>
                                                                </select>
                                                            </div>
                                                            <div id="{{ $gross_key }}_neuwest"
                                                                ...
                                                                <input type="hidden" id="{{ $gross_key }}_value"
                                                                    name="{{ $gross_key }}"
                                            ...
                                            <tr class="total-line-top totalsetting no-fixed-header" id="discount_row">
                                                ...
                                                @foreach ($allQuotes as $key => $quotes1)
                                                    ...
                                                    <th colspan="2" data-dt-order="disable"
                                                        ...
                                                        <span class="dt-column-title">
                                                            <div id="{{ $markup_key }}_neuwest"
                                                                class="totalnr {{ $markup_key }} toptotal total-markup">
                                                                @if ($user->type != 'company')
                                                                    <input type="hidden" id="{{ $markup_key }}"
                                                                        name="markup[{{ $markup_key }}]"
                                                                ...
                                                                @else
                                                                    <div class="total-setting-label">{{ __('Markup') }}
                                                                    </div>
                                                                    <div class="total-markup-input">
                                                                        <input type="text" id="{{ $markup_key }}"
                                                                            name="markup[{{ $markup_key }}]"
                                                                            data-old="{{ $markup[$markup_key]->markup }}"
                                                                            value="{{ currency_format_with_sym($markup[$markup_key]->markup, '', '', false) }}"
                                                                            class="form-control"
                                                            ...
                                                            <div id="{{ $discount_key }}_neuwest"
                                                                class="totalnr {{ $discount_key }}toptotal total-markup">
                                                                <div class="total-setting-label">{{ __('Cash Discount') }}
                                                                </div>
                                                                <div class="total-discount-input">
                                                                    <input type="text" id="{{ $discount_key }}"
                                                                        name="discount[{{ $discount_key }}]"
                                                                        value="{{ $discount[$discount_key] }}"
                                                                        class="form-control">
                                                                </div>
                                                            </div>
                                </div>
                                ...
                                <tr class="total-line-top" id="contractors_row">
                                                    ...
                                                    <div class="dropdown-menu dash-h-dropdown">
                                                        ...
                                                        <label class="dropdown-item">
                                                            <input type="checkbox" class="column-toggle"
                                                                data-column="column_pos" checked>
                                                            <span>{{ __('Pos') }}</span>
                                                        </label>
                                                        {{-- <label class="dropdown-item">
                                                        ...
                                                        <label class="dropdown-item">
                                                            <input type="checkbox" class="column-toggle"
                                                                data-column="column_unit" checked>
                                                            <span>{{ __('Unit') }}</span>
                                                        </label>
                                                        <label class="dropdown-item">
                                                            <input type="checkbox" class="column-toggle"
                                    ...
                                    <th colspan="3" data-orderable="false" data-dt-order="disable"
                                        class="toplabel markup_discount_th"></th>
                                    @if (isset($ai_description_field))
                                        <th id=""
                                                ...
                                                <div class="row m-1 ai-progress-bar">
                                                    @foreach ($queues_result['estimation_queues_list'] as $qrow)
                                                        @if ($qrow['completed_percentage'] >= 0 && $qrow['completed_percentage'] < 100 && $qrow['type'] == 0)
                                                            <div class="col-md-12 project_block"
                                                                data-id="{{ $estimation->project_id }}">
                                                                <div class="form-group estimation_block"
                                        ...
                                        <th colspan="2" data-orderable="false"
                                            ...
                                            <div class="total-company-title-inner">
                                                ...
                                                <div class="company-total-settings {{ $hide_options }}">
                                                    <i class="ti ti-settings float-end"
                                                        id="dropdownMenuButton{{ $quotes->id }}"
                                                    ...
                                                    <ul class="dropdown-menu quote_options{{ $quotes->id }}"
                                                        ...
                                                        @if (Auth::user()->type == 'company')
                                                            ...
                                                            <li>
                                                                <label class="dropdown-item">
                                                                    <input type="checkbox"
                                                                        id="sub_contractor_quote_checkbox"
                                                        ...
                                                        @if (
                                                            ...
                                                            <div class="col-md-12 project_block"
                                                                ...
                                                                <span class="CellWithComment {{ $info_icon }}">
                                                                    ...
                                                                    <span
                                                                        class="CellComment">{{ $qrow['error_message'] }}</span>
                                                                </span>
                                                            </div>
                                                        @endif
                                                    @endforeach
                                            ...
                                            @endif
                                            <input type="hidden" class="sc{{ $quotes->id }}_value"
                                                value="{{ $quote_title }}">
                                            @php
                                                if ($user->type != 'company') {
                                                    $hide_options = 'hide';
                            ...
                            <tr id="estimation-edit-table-thead">
                                ...
                                @foreach ($allQuotes as $key => $quotes)
                                    <th class="column_single_price border-left quote_th{{ $quotes->id }}"
                                        data-dt-order="disable">{{ __('Single Price') }}</th>
                                    <th class="column_total_price border-right quote_th{{ $quotes->id }}"
                                        data-dt-order="disable">{{ __('Total Price') }}</th>
                                @endforeach
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            @if (Auth::user()->type == 'company')
                                <div class="estimation-footer-box">
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea rows="3" class="form-control border-0 resize-none tinyMCE" name="technical_description"
                                            id="technical_description" placeholder="{{ __('Technical Description') }}">
...
@endif
                                        ...
                                        <span>
                                            ...
                                            <div class="dropdown-menu dash-h-dropdown">
                                                @permission('estimation remove option')
                                                    <a id="remove_items_btn"
                                                        class="remove_items_btn dropdown-item"><span>{{ __('Remove') }}</span></a>
                                                @endpermission
                                ...
                                @if ($user->type == 'company')
                                    <div class="select-smart-template-div">
                                        ...
                                        <button id="smart_template_generate"
                                            class="call-ai-smart-template sb-go-btn sb-go-selected ai_fields d-none">{{ __('Go') }}</button>
                                    </div>
                                @endif
                            </div>
    ...
    <div class="modal fade" data-backdrop="static" id="group_reorder_Modal" tabindex="-1" role="dialog"
        aria-hidden="true">
