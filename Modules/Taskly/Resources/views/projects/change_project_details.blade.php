...
{{ Form::open(['route' => ['project.update_details', [$project_id, $form_field]], 'method' => 'post', 'id' => 'title_form', 'class' => 'project_detail_form']) }}
<div class="card-body p-0">
    <div class="row">
        @if ($form_field == 'title')
            <div class="col-md-12">
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="{{ __('Project Title') }}" name="title"
                        ...
                        <div class="col-md-12 row d-none" id="client-details">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="d-flex radio-check">
                                        <div class="form-check m-1">
                                            <input type="radio" value="Mr." id="client-salutation_mr"
                                                name="salutation" class="form-check-input">
                                            <label class="form-check-label"
                                                for="client-salutation_mr">{{ __('Mr.') }}</label>
                                        </div>
                                        <div class="form-check m-1">
                                            <input type="radio" value="Ms." id="client-salutation_ms"
                                                name="salutation" class="form-check-input">
                                            <label class="form-check-label"
                                                for="client-salutation_ms">{{ __('Ms.') }}</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" placeholder="{{ __('First Name') }}"
                                        id="client-first_name" name="first_name" type="text">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="client_last_name" class="form-label">{{ __('Last Name') }}</label>
                                    <input class="form-control" placeholder="{{ __('Last Name') }}"
                                        id="client-last_name" name="last_name" type="text">
                                </div>

                                <div class="form-group col-md-12">
                                    <label>{{ __('Location/City/Address') }}</label>
                                    <input type="text" name="autocomplete" id="invoice-autocomplete"
                                        class="form-control" placeholder="{{ __('Choose Location') }}">
                                    <input type="hidden" id="invoice-latitude" name="latitude" class="form-control">
                                    <input type="hidden" id="invoice-longitude" name="longitude"
                                        class="form-control">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="client_address_1" class="form-label">{{ __('Street + Nr.') }}</label>
                                    <input class="form-control invoice-address_1" placeholder="{{ __('Address 1') }}"
                                        id="invoice-address_1" name="address_1" type="text">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="client_address_2"
                                        class="form-label">{{ __('Additional Address') }}</label>
                                    <input class="form-control" placeholder="{{ __('Address 2') }}"
                                        id="invoice-address_2" name="address_2" type="text">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="client_zip_code" class="form-label">{{ __('Zipcode') }}</label>
                                    <input class="form-control" placeholder="{{ __('Zipcode') }}"
                                        id="invoice-zip_code" name="zip_code" type="text">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="client_city" class="form-label">{{ __('City') }}</label>
                                    <input class="form-control" placeholder="{{ __('City') }}" id="invoice-city"
                                        name="city" type="text">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="invoice-district_1" class="form-label">{{ __('District 1') }}</label>
                                    <input class="form-control" placeholder="{{ __('District 1') }}"
                                        id="invoice-district_1" name="district_1" type="text">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="invoice-district_2" class="form-label">{{ __('District 2') }}</label>
                                    <input class="form-control" placeholder="{{ __('District 2') }}"
                                        id="invoice-district_2" name="district_2" type="text">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="client_state" class="form-label">{{ __('State') }}</label>
                                    <input class="form-control" placeholder="{{ __('State') }}" id="invoice-state"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" placeholder="{{ __('Email') }}" id="client-email"
                                        name="email" type="text">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="client_phone" class="form-label">{{ __('Phone') }}</label>
                                    <input class="form-control" placeholder="{{ __('Phone') }}" id="client-phone"
                                        name="phone" type="text">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="client_mobile" class="form-label">{{ __('Mobile') }}</label>
                                    <input class="form-control" placeholder="{{ __('Mobile') }}" id="client-mobile"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input class="form-control" placeholder="{{ __('Company Name') }}"
                                        id="client-company_name" name="company_name" type="text">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="client_company_website"
                                        class="form-label">{{ __('Website') }}</label>
                                    <input class="form-control" placeholder="{{ __('Website') }}"
                                        id="client-company_website" name="website" type="text">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="client_company_tax_number"
                                        class="form-label">{{ __('Tax Number') }}</label>
                                    <input class="form-control" placeholder="{{ __('Tax Number') }}"
                                        id="client-company_tax_number" name="tax_number" type="text">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <textarea rows="3" id="client-company_notes" class="form-control border-0 resize-none client-company_notes"
                                        name="notes" placeholder="{{ __('Notes') }}"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                <div class="client-details">
                    <div class="form-group col-md-12 selct2-custom">
                        ...
                        <select name="client_estimation" id="client_estimation_id" class="form-control">
                            ...
                            @foreach ($estimation_quotes as $quote)
                                <option value="{{ $quote->id }}"> {{ $quote->title }}
                                    ({{ $quote->estimation->title }}) - {{ $quote->net }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-12 selct2-custom">
                        ...
                        <select name="sub_contractor_estimation" id="sub_contractor_estimation_id"
                            class="form-control">
                            <option value="" data-type="">{{ __('Select') }}</option>
                            @foreach ($estimation_quotes as $quote)
                                <option value="{{ $quote->id }}"> {{ $quote->title }}
        ...
        @elseif($form_field == 'ConstructionDetails')
            <div class="col-md-6">
                ...
                <div class="col-md-12">
                    ...
                    <label class="custom-control-label"
                        for="same_invoice_address">{{ __('Same Invoice Address') }}</label>
                </div>
            ...
            <div class="col-md-6">
                <div
                    class="client-details different-invoice-address-block @if (isset($project->is_same_invoice_address) && $project->is_same_invoice_address == 1) d-none @endif">
                    <div class="form-group col-md-12 selct2-custom">
        ...
        @elseif($form_field == 'technical_description')
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="2" name="technical_description" id="technical-description"
                        spellcheck="false">{{ isset($project->technical_description) ? $project->technical_description : '' }}</textarea>
                </div>
            </div>
        @endif
    </div>
