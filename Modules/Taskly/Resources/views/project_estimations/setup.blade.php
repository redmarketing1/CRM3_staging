                                ...
                                <div class="row estimation-header">
                                    ...
                                    <div class="col-md-3">
                                        <fieldset @if ($estimation->status == 2) disabled @endif>
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="title" id="estimation_title"
                                                    type="text" value="{{ $estimation->title }}">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group not-disable">
                                            {{ Form::label('status', __('Status'), ['class' => ' d-block form-label']) }}
                                ...
                                <fieldset @if ($estimation->status == 2) disabled @endif>
                                                            ...
                                                            <span class="dt-column-title">
                                                                <div id="{{ $tax_key }}_neuwest"
                                                                    ...
                                                                    <select name="tax[{{ $tax_key }}]"
                                                                        id="{{ $tax_key }}">
                                                                        <option value="19"
                                                                            {{ $tax[$tax_key] == 19 ? 'selected' : '' }}>
                                                                            19%
                                                                        </option>
                                                                        <option value="0"
                                                                            {{ $tax[$tax_key] == 0 ? 'selected' : '' }}>0%
                                                                        </option>
                                                                    </select>
                                                                </div>
                                    ...
                                    <tr class="total-line-top" id="contractors_row">
                                        <th colspan="4" class="toplabel buttons-top" data-dt-order="disable">
                                            ...
                                            <input type="hidden" name="" id="duplicate_group_ids"
                                                value="">
