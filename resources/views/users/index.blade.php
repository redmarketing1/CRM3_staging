                                ...
                                <div class="btn-group card-option">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">
                                        @permission('user edit')
                                            <a href="{{ route('users.setup',[\Crypt::encrypt($user->id)]) }}" class="dropdown-item" title="{{ __('Update '.($singular_name)) }}">
        ...
        @auth('web')
            @permission('user create')
                <div class="col-md-3 All">
                    <a href="{{route('user.setup')}}" class="btn-addnew-project " style="padding: 90px 10px;" title="{{ __('Create New '.($singular_name)) }}">
