...
return [
    ...
    */
    'all_assets'      => [
        ...
        'project.show.css'                  => ['public' => 'assets/css/project.show.css'],
        'project.show.js'                   => ['public' => 'assets/js/project.show.js'],

        'project.google.map.js'             => ['Cdn' => 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBbTqlUNbqPssvetzvRl4n65HB2g_-o9tE&libraries=places&d?.js'],
